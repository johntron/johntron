...
intake_plenum_dimensions = [300, 300, 100];
exhaust_plenum_dimensions = [300, 300, 100];
module filtration() {
  module fans() {
    right(fan_extents.x) cube(fan_extents);
    cube(fan_extents);
  }

  module intake_plenum() {
    up(fan_extents.z) cube(intake_plenum_dimensions);
  }

  module exhaust_plenum() {
    down(exhaust_plenum_dimensions.z) cube(exhaust_plenum_dimensions);
  }
